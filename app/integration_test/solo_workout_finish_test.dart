...
void main() {
  ...
  testWidgets('solo — start, log a set, and finish the workout', (
    tester,
  ) async {
    ...
    expect(
      await s.waitForText('This will end your current workout.', seconds: 6),
      isTrue,
    ...
    s.note(
      'Full workout lifecycle verified',
