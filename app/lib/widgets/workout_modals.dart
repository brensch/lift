          ...
          child: Column(
            ...
            children: [
              ...
              for (var i = 0; i < steps.length; i++)
                _HeartRateStep(leading: '${i + 1}.', text: steps[i]),
              ...
              for (final fix in fixes) _HeartRateStep(leading: '•', text: fix),
            ],
          ),
        ),
        actions: [
...
class _HeartRateStep extends StatelessWidget {
  ...
  final String text;
  const _HeartRateStep({required this.leading, required this.text});
