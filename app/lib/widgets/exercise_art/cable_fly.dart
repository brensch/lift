...
ExerciseArt cableFlyArt() =>
    const ExerciseArt(machine: true, view: ExerciseView.front, [
      ...
      Pose(
        figure: Figure(
          ...
          arms: [
            Limb(10, -30),
            Limb(170, -150),
          ], // arms angled slightly down in front
          legs: [Limb(91, 91), Limb(89, 89)],
        ),
        props: [
        ...
        propDiscs: [PropDisc(P(8, 15), 5), PropDisc(P(92, 15), 5)],
      ),
    ]);
