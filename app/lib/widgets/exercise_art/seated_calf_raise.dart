...
ExerciseArt seatedCalfRaiseArt() => const ExerciseArt(machine: true, [
  ...
  Pose(
    figure: Figure(
      ...
      legs: [
        Limb(1, 115),
        Limb(3, 113),
      ], // thighs horizontal, shins angled well past vertical — heels back
    ),
    props: [
  ...
  Pose(
    figure: Figure(
      ...
      legs: [
        Limb(1, 60),
        Limb(3, 62),
      ], // shins well forward of vertical — heels high
    ),
    props: [
      [P(10, 44), P(10, 80)],
      [P(10, 62), P(48, 62)],
