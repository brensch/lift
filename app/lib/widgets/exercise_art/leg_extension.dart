...
ExerciseArt legExtensionArt() => const ExerciseArt(machine: true, [
  ...
  Pose(
    figure: Figure(
      ...
      legs: [
        Limb(0, 91),
        Limb(2, 89),
      ], // thighs horizontal forward, shins hang down
    ),
    props: [
  ...
  Pose(
    figure: Figure(
      ...
      legs: [
        Limb(0, 0),
        Limb(2, 2),
      ], // thighs horizontal, shins also horizontal
    ),
    props: [
      [P(10, 48), P(10, 82)],
      [P(10, 68), P(48, 68)],
    ...
    propDiscs: [
      PropDisc(P(73, 58), 5),
    ], // ankle roller disc moves up with extended shin
  ),
]);
