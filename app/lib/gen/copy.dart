...
class CopyOnboardingBody {
  final String title;
  final String body;
  final String genderHeading;
  final String female;
  final String male;
  final String bodyweight;
  final String experienceHeading;
  final List<CopyOnboardingBodyLevelsItem> levels;
  final String papersLink;
  final String failed;
  const CopyOnboardingBody({
    required this.title,
    required this.body,
    required this.genderHeading,
    required this.female,
    required this.male,
    required this.bodyweight,
    required this.experienceHeading,
    required this.levels,
    required this.papersLink,
    required this.failed,
  });
}

class CopyOnboardingBodyLevelsItem {
  final String emoji;
  final String label;
  const CopyOnboardingBodyLevelsItem({
    required this.emoji,
    required this.label,
  });
}
...
class CopyOnboardingMarker {
  ...
  final String emojisHeading;
  final String refresh;
  final String colourHeading;
  const CopyOnboardingMarker({
    required this.title,
    required this.body,
    required this.previewHeading,
    required this.previewBody,
    required this.emojisHeading,
    required this.refresh,
    required this.colourHeading,
  });
}
