...
@$core.Deprecated('Use pendingStateUpdateFieldDescriptor instead')
const PendingStateUpdateField$json = {
  '1': 'PendingStateUpdateField',
  '2': [
    {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    {'1': 'label', '3': 2, '4': 1, '5': 9, '10': 'label'},
    {
...
/// Descriptor for `PendingStateUpdateField`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List pendingStateUpdateFieldDescriptor = $convert.base64Decode(
    'ChdQZW5kaW5nU3RhdGVVcGRhdGVGaWVsZBIQCgNrZXkYASABKAlSA2tleRIUCgVsYWJlbBgCIA'
    'EoCVIFbGFiZWwSLgoEa2luZBgDIAEoDjIaLndvcmtvdXQudjEuU3RhdGVGaWVsZEtpbmRSBGtp'
    'bmQSQAoNZGVmYXVsdF92YWx1ZRgEIAEoCzIbLndvcmtvdXQudjEuU3RhdGVGaWVsZFZhbHVlUg'
    'xkZWZhdWx0VmFsdWUSGwoJbWluX3ZhbHVlGAUgASgBUghtaW5WYWx1ZRIbCgltYXhfdmFsdWUY'
    'BiABKAFSCG1heFZhbHVlEhIKBHN0ZXAYByABKAFSBHN0ZXASPgoMZW51bV9vcHRpb25zGAggAy'
    'gLMhsud29ya291dC52MS5TdGF0ZUVudW1PcHRpb25SC2VudW1PcHRpb25z');

@$core.Deprecated('Use pendingStateUpdateDescriptor instead')
const PendingStateUpdate$json = {
  '1': 'PendingStateUpdate',
  '2': [
    ...
    {'1': 'message', '3': 3, '4': 1, '5': 9, '10': 'message'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.workout.v1.PendingStateUpdateField',
      '10': 'fields'
    },
  ],
};

/// Descriptor for `PendingStateUpdate`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List pendingStateUpdateDescriptor = $convert.base64Decode(
    'ChJQZW5kaW5nU3RhdGVVcGRhdGUSGwoJdXBkYXRlX2lkGAEgASgJUgh1cGRhdGVJZBIUCgV0aX'
    'RsZRgCIAEoCVIFdGl0bGUSGAoHbWVzc2FnZRgDIAEoCVIHbWVzc2FnZRI7CgZmaWVsZHMYBCAD'
    'KAsyIy53b3Jrb3V0LnYxLlBlbmRpbmdTdGF0ZVVwZGF0ZUZpZWxkUgZmaWVsZHM=');
...
@$core.Deprecated('Use applyPendingStateUpdateRequestDescriptor instead')
const ApplyPendingStateUpdateRequest$json = {
  '1': 'ApplyPendingStateUpdateRequest',
  '2': [
    {'1': 'update_id', '3': 1, '4': 1, '5': 9, '10': 'updateId'},
    {
      '1': 'field_values',
      ...
      '4': 3,
      '5': 11,
      '6': '.workout.v1.ApplyPendingStateUpdateRequest.FieldValuesEntry',
      '10': 'fieldValues'
    },
  ],
  '3': [ApplyPendingStateUpdateRequest_FieldValuesEntry$json],
};

@$core.Deprecated('Use applyPendingStateUpdateRequestDescriptor instead')
const ApplyPendingStateUpdateRequest_FieldValuesEntry$json = {
  '1': 'FieldValuesEntry',
  '2': [
    {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    {
...
/// Descriptor for `ApplyPendingStateUpdateRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List applyPendingStateUpdateRequestDescriptor = $convert.base64Decode(
    'Ch5BcHBseVBlbmRpbmdTdGF0ZVVwZGF0ZVJlcXVlc3QSGwoJdXBkYXRlX2lkGAEgASgJUgh1cG'
    'RhdGVJZBJeCgxmaWVsZF92YWx1ZXMYAiADKAsyOy53b3Jrb3V0LnYxLkFwcGx5UGVuZGluZ1N0'
    'YXRlVXBkYXRlUmVxdWVzdC5GaWVsZFZhbHVlc0VudHJ5UgtmaWVsZFZhbHVlcxpbChBGaWVsZF'
    'ZhbHVlc0VudHJ5EhAKA2tleRgBIAEoCVIDa2V5EjEKBXZhbHVlGAIgASgLMhsud29ya291dC52'
    'MS5TdGF0ZUZpZWxkVmFsdWVSBXZhbHVlOgI4AQ==');

@$core.Deprecated('Use applyPendingStateUpdateResponseDescriptor instead')
const ApplyPendingStateUpdateResponse$json = {
  '1': 'ApplyPendingStateUpdateResponse',
  '2': [
    {
      '1': 'state',
      '3': 1,
...
/// Descriptor for `ApplyPendingStateUpdateResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List applyPendingStateUpdateResponseDescriptor =
    $convert.base64Decode(
        'Ch9BcHBseVBlbmRpbmdTdGF0ZVVwZGF0ZVJlc3BvbnNlEjYKBXN0YXRlGAEgASgLMiAud29ya2'
        '91dC52MS5UcmFpbmluZ1Byb2dyYW1TdGF0ZVIFc3RhdGU=');
