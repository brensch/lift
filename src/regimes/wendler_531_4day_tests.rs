...
#[test]
fn classic_4day_names_single_lift_and_advances_week_after_4_sessions() {
    let regime = Wendler5314DayRegime;
    ...
    assert!(name.contains("Week 2"));
    assert!(name.contains("Squat"));
}
